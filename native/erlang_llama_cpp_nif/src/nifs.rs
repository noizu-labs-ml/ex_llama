...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn __nif_default_session_options__() -> ExLLamaSessionOptions {
    ExLLamaSessionOptions::from(SessionParams::default())
}

#[rustler::nif(schedule = "DirtyCpu")]
pub fn __nif_create_session__(model: ExLLamaModel, options: ExLLamaSessionOptions) -> Result<ExLLamaSession, ()> {
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn __nif_advance_context__(session:  ResourceArc<ExLLamaSessionRef>, context: String) -> Result<(), &'static str> {
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn __nif_complete__(session: ResourceArc<ExLLamaSessionRef>, tokens: usize) -> Result<String, &'static str> {
