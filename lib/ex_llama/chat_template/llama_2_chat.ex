defmodule ExLLama.ChatTemplate.LLama2Chat do
  @moduledoc """
  based on: [https://github.com/chujiezheng/chat_templates/blob/main/chat_templates/llama-2-chat.jinja]
  ```jinja
  ...
  # ⟦𓁉𓌕𓇡𓍾⟧ support_list :: auto-generated pointer for public function support_list
  def support_list() do
    [ ]
  end
  ...
  defp format_line(message, bos_token, eos_token) do
    case message.role do
      :user -> "#{bos_token}[INST] #{String.trim(message.content)} [/INST]"
      :assistant -> " #{String.trim(message.content)} #{eos_token}"
    end
  end

  # ⟦𓁜𓎁𓋖𓎒⟧ extract_response :: auto-generated pointer for public function extract_response
  ...
  # ⟦𓁐𓋏𓈋𓏣⟧ compact :: auto-generated pointer for public function compact
  ...
  # ⟦𓀡𓇳𓁾𓃆⟧ to_context :: auto-generated pointer for public function to_context
